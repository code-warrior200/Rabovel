    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="28" y="14" width="4" height="12" fill="#34D399"/>
         ...
         {/* Arrows */}
        <path d="M35 10 L30 5" stroke="#374151" strokeWidth="2" />
        <path d="M30 5 L33 5 L33 8" stroke="#374151" strokeWidth="2" fill="none" />
        
        <path d="M5 30 L10 35" stroke="#374151" strokeWidth="2" />
        <path d="M10 35 L7 35 L7 32" stroke="#374151" strokeWidth="2" fill="none" />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current">
        ...
        <path d="M30 18 L34 14 L30 10" stroke="#34D399" strokeWidth="2" fill="none" />
        <line x1="34" y1="14" x2="18" y2="14" stroke="#34D399" strokeWidth="2" />
      </svg>
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" className="fill-current" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M16 28 L14 22 L18 24 L12 26" stroke="#D32F2F" strokeWidth="2" fill="none" />
